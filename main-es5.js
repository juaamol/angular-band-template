...
var BookingCardComponent = /** @class */ (function () {
    ...
    BookingCardComponent.prototype.receivedFunction = function () {
...
var BookingInfoComponent = /** @class */ (function () {
...
var CarouselComponent = /** @class */ (function () {
    ...
    CarouselComponent.prototype.setInterval = function () {
        var _this = this;
        if (this.auto.enable) {
    ...
    CarouselComponent.prototype.clearInterval = function () {
        if (this.interval) {
            clearInterval(this.interval);
        }
    };
    CarouselComponent.prototype.transition = function () {
        return { transition: "transform " + this.timing + "ms, opacity " + this.timing + "ms, z-index " + this.timing + "ms" };
    };
    CarouselComponent.prototype.setInitialClasses = function () {
        var _this = this;
        this.itemsElements.forEach(function (item, index) {
            if (index === 0) {
                item.nativeElement.className = _this.carouselItemClassName + " initial active";
            }
            if (index === 1) {
                item.nativeElement.className = _this.carouselItemClassName + " next";
            }
            if (index === _this.totalItems - 1) {
                item.nativeElement.className = _this.carouselItemClassName + " prev";
            }
        });
    };
    // Next navigation handler
    CarouselComponent.prototype.moveNext = function () {
    ...
    CarouselComponent.prototype.movePrev = function () {
    ...
    CarouselComponent.prototype.moveCarouselTo = function (slide) {
        var _this = this;
        this.clearInterval();
        ...
        if (this.totalItems > 3) {
            ...
            this.itemsElements.forEach(function (item, index) {
                item.nativeElement.className = _this.carouselItemClassName;
                // Add new classes
                if (index === slide) {
                    item.nativeElement.className = _this.carouselItemClassName + " active";
                }
                if (index === newNext) {
                    item.nativeElement.className = _this.carouselItemClassName + " next";
                }
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.toggleOpen = function () {
